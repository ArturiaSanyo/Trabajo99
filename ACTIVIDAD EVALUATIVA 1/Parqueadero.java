...
public class Parqueadero{
    // Variables globales
    static final int NUM_PUESTOS = 10; // Número total de los puestos del parqueadero
    ...
    public static void main(String[] args){
        ...
        do {
            // Menú principal
            System.out.println("Menú Principal Bienvenido:");
            ...
            switch (opcion) {
                case 1:
                    // Submenú del registro de motos
                    menuRegistroMotos();
                    break;
                case 2:
                    // Submenú de los cobros del parqueadero
                    menuCobros();
                    break;
                case 3:
    ...
    public static void menuRegistroMotos() {
        System.out.println("Seleccione cual es el tipo de moto:");
        ...
        switch (opcion) {
            case 1:
                ...
                // En esta parte se busca agregar los detalles de la moto de bajo cilindraje
                break;
            case 2:
                // Registro de moto de alto cilindraje
                System.out.println("Registrar moto de Alto Cilindraje:");
                // En esta parte se busca agregar los detalles de la moto de alto cilindraje
                break;
            default:
                System.out.println("Opción no válida.");
                break;
    ...
    public static void menuCobros() {
        ...
        if (puestoSeleccionado < 0 || puestoSeleccionado >= NUM_PUESTOS || puestos[puestoSeleccionado]) {
            System.out.println("Este puesto no está disponible en este momento. Seleccione otro.");
        } else {
            puestos[puestoSeleccionado] = true; // Marcar el puesto como ocupado
            System.out.println("Puesto asignado correctamente.");

            System.out.print("Ingrese cual es el tiempo de estacionamiento en minutos: ");
    ...
    public static void calcularCobro(int tiempoEstacionamiento) {
        ...
        if (tiempoEstacionamiento <= 30) {
            costo = 0; // Primeros 30 minutos son completamente gratuitos
        } else if (tiempoEstacionamiento <= 60) {
            costo = 600; // Entre 31 y 60 minutos
        } else {
            costo = 2500; // Más de 60 minutos
        }
        System.out.println("Los costos por el tiempo de estacionamiento es: $" + costo);
    }
}
